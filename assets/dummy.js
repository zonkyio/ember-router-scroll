...
define('dummy/ember-router-scroll/tests/ember-router-scroll/index.jshint.lint-test', [], function () {
  'use strict';

  QUnit.module('JSHint | ember-router-scroll/index.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ember-router-scroll/index.js should pass jshint.');
  });
});
define('dummy/ember-router-scroll/tests/ember-router-scroll/locations/router-scroll.jshint.lint-test', [], function () {
  'use strict';

  QUnit.module('JSHint | ember-router-scroll/locations/router-scroll.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ember-router-scroll/locations/router-scroll.js should pass jshint.');
  });
});
define('dummy/ember-router-scroll/tests/ember-router-scroll/services/router-scroll.jshint.lint-test', [], function () {
  'use strict';

  QUnit.module('JSHint | ember-router-scroll/services/router-scroll.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ember-router-scroll/services/router-scroll.js should pass jshint.');
  });
});
  ...
  exports.default = Ember.HTMLBars.template(function () {
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el2, "src", "./images/tentacle-monster.png");
        dom.setAttribute(el2, "id", "monster");
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
      ...
      statements: [["block", "link-to", ["next-page"], [], 0, null, ["loc", [null, [5, 2], [5, 94]]]], ["content", "outlet", ["loc", [null, [38, 0], [38, 10]]]]],
      locals: [],
      templates: [child0]
    };
  }());
});
define("dummy/templates/next-page", ["exports"], function (exports) {
  "use strict";
  ...
  exports.default = Ember.HTMLBars.template(function () {
    var child0 = function () {
      return {
        meta: {
          ...
          "moduleName": "dummy/templates/next-page.hbs"
        },
        isEmpty: false,
        arity: 0,
        cachedFragment: null,
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el3, "src", "./images/death-star.png");
        dom.setAttribute(el3, "id", "death-star");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n    ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
      ...
      statements: [["block", "link-to", ["application"], [], 0, null, ["loc", [null, [12, 4], [12, 111]]]]],
      locals: [],
      templates: [child0]
    };
  }());
